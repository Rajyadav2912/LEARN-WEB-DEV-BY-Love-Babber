...
// console.log("Index Orange: ", fruits.indexOf("orange")); // Index Orange:  1
...
// console.log(newArr); // [ 'apple', 'orange', 'banana', 'papaya', 'bluebarry', 'graps', 'mango' ]
...
// console.log(newArr); // 1 and 2 and 3
...
// console.log(newArr); // [ 'Hey', 'there','my', 'name', 'Raj', 'Yadav' ]

// let joinArr = newArr.join("_");

// console.log(joinArr); // Hey_there_my_name_Raj_Yadav
...
// arr2.sort();
// console.log(arr2); // ["A", "B", "C", "D", "E", "F", "G", "H"];

// arr2.reverse();
// console.log(arr2); // ["H", "G", "F", "E", "D", "C", "B", "A"];
